...
export function IconButton({
  ...
  const dims = ({ sm: 32, md: 40, lg: 48 } as const)[size] || 40;
  ...
  return (
    <button
      ...
      style={{
        ...
        transition:
          'background var(--dur-base) var(--ease-out), transform var(--dur-fast) var(--ease-out), box-shadow var(--dur-base) var(--ease-out)',
