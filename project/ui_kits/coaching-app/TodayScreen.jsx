...
function TodayScreen({ onStartWorkout }) {
  const { Card, StatTile, ProgressRing, Badge, Avatar, Button } = window.JiadHilalDesignSystem_e787fe;
  return (
    <div style={{ background: 'var(--surface-dark)', color: 'var(--white)', minHeight: '100%', paddingBottom: 16 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 22px 8px' }}>
        <div>
          <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--gray-400)' }}>Tuesday · Week 4</div>
          <div style={{ fontFamily: 'var(--font-display)', fontStyle: 'italic', fontWeight: 900, fontSize: 26, textTransform: 'uppercase', letterSpacing: '-0.02em', marginTop: 2 }}>Let's go, Sam</div>
        </div>
      ...
      <div style={{ padding: '6px 22px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <Card variant="brand" interactive onClick={onStartWorkout} padding="20px">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <Badge tone="green" variant="solid" dot>Today</Badge>
            <Icon name="dumbbell" size={26} color="rgba(255,255,255,0.85)" />
          </div>
          <div style={{ fontFamily: 'var(--font-display)', fontStyle: 'italic', fontWeight: 900, fontSize: 30, textTransform: 'uppercase', letterSpacing: '-0.02em', marginTop: 14, lineHeight: 1 }}>
            Push Day A
          </div>
          <div style={{ fontSize: 14, opacity: 0.85, marginTop: 6 }}>6 exercises · 52 min · chest, shoulders, triceps</div>
          <div style={{ marginTop: 18 }}>
            <Button variant="neon" size="md" iconRight={<Icon name="arrow-right" size={18} />}>Start workout</Button>
          </div>
        </Card>
        ...
        <div style={{ display: 'flex', gap: 14 }}>
          <Card variant="dark" padding="18px" style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 16 }}>
            <ProgressRing value={75} sublabel="This week" size={84} />
            <div>
        ...
        <Card variant="dark" padding="16px" style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--purple-300)' }}>Note from Jiad</div>
            <div style={{ fontSize: 13.5, color: 'var(--gray-200)', marginTop: 3, lineHeight: 1.45 }}>Strong bench last week. Keep the bar path tight today — chest, not shoulders.</div>
          </div>
        </Card>
      </div>
    </div>
